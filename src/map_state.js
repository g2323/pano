...
class MapState {
	constructor(width, height, zoomLevel, tilesServiceUrl, centerLatitude, centerLongitude, centerViewX, centerViewY) {
...
export const appMapState = (function() {
	...
	const sharedMapState = new MapState(512, 512, 12, 'https://map.psi.de/tiles/', 50.957689, 7.044405, 0.5, 0.5);
